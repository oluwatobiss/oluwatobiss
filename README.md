...
1. 🚀 Published release [Release 2.1.1](https://github.com/codesweetly/react-image-grid-gallery/releases/tag/v2.1.1) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
2. 🎉 Merged PR [#8](https://github.com/codesweetly/react-image-grid-gallery/pull/8) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
3. 💪 Opened PR [#8](https://github.com/codesweetly/react-image-grid-gallery/pull/8) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
4. 🚀 Published release [Release 2.1.0](https://github.com/codesweetly/react-image-grid-gallery/releases/tag/v2.1.0) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
5. 🎉 Merged PR [#7](https://github.com/codesweetly/react-image-grid-gallery/pull/7) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
