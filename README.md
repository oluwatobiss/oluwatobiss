...
1. 🚀 Published release [Release 2.0.0](https://github.com/codesweetly/react-image-grid-gallery/releases/tag/v2.0.0) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
2. 🎉 Merged PR [#2](https://github.com/codesweetly/react-image-grid-gallery/pull/2) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
3. 💪 Opened PR [#2](https://github.com/codesweetly/react-image-grid-gallery/pull/2) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
4. 🎉 Merged PR [#1](https://github.com/codesweetly/react-image-grid-gallery/pull/1) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
5. 💪 Opened PR [#1](https://github.com/codesweetly/react-image-grid-gallery/pull/1) in [codesweetly/react-image-grid-gallery](https://github.com/codesweetly/react-image-grid-gallery)
